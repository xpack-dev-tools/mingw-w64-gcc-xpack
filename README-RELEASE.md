...
- `xbbmi`: 1h08
- `xbbma`: 28m
- `xbbli`: 1h12 (26m Linux, 46m Windows)
- `xbbla64`: 2h32
- `xbbla32`: 2h28
...
- commit all changes, use a message like
  _package.json: update urls for 11.3.0-1.2 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v11.3.0-1.2 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v11.3.0-1.2_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 11.3.0-1.2`; the first 4 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@11.3.0-1.2 latest`
- `npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc`
