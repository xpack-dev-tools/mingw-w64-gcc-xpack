...
total 557080
-rw-r--r--  1 ilg  staff  271965952 Jun 26 14:42 xpack-mingw-w64-gcc-12.4.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff        113 Jun 26 14:42 xpack-mingw-w64-gcc-12.4.0-1-darwin-x64.tar.gz.sha
```
...
total 524312
-rw-r--r--  1 ilg  staff  259834172 Jun 26 14:37 xpack-mingw-w64-gcc-12.4.0-1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff        115 Jun 26 14:37 xpack-mingw-w64-gcc-12.4.0-1-darwin-arm64.tar.gz.sha
```
...
total 302124
-rw-rw-rw- 1 ilg ilg 309364799 Jun 26 11:52 xpack-mingw-w64-gcc-12.4.0-1-linux-x64.tar.gz
-rw-rw-rw- 1 ilg ilg       112 Jun 26 11:52 xpack-mingw-w64-gcc-12.4.0-1-linux-x64.tar.gz.sha
```
...
total 343356
-rw-rw-rw- 1 ilg ilg 351586013 Jun 26 11:53 xpack-mingw-w64-gcc-12.4.0-1-win32-x64.zip
-rw-rw-rw- 1 ilg ilg       109 Jun 26 11:53 xpack-mingw-w64-gcc-12.4.0-1-win32-x64.zip.sha
```
...
total 293644
-rw-r--r-- 1 ilg ilg 300680800 Jun 26 14:59 xpack-mingw-w64-gcc-12.4.0-1-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg       114 Jun 26 14:59 xpack-mingw-w64-gcc-12.4.0-1-linux-arm64.tar.gz.sha
```
...
total 273600
-rw-r--r-- 1 ilg ilg 280157809 Jun 26 14:13 xpack-mingw-w64-gcc-12.4.0-1-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg       112 Jun 26 14:13 xpack-mingw-w64-gcc-12.4.0-1-linux-arm.tar.gz.sha
```
...
```sh
.../xpack-mingw-w64-gcc-12.4.0-1/bin/mingw-w64-gcc --version
gcc (xPack MinGW-w64 GCC x86_64) 12.4.0
```

On Windows use:

```dos
...\xpack-mingw-w64-gcc-12.4.0-1\bin\gcc --version
gcc (xPack MinGW-w64 GCC x86_64) 12.4.0
```
...
named like **xPack MinGW-w64 GCC v12.4.0-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack MinGW-w64 GCC v12.4.0-1 released_
- push to GitHub
...
the `12.4.0-1.md` file to the web site `pages/dev-tools/mingw-w64-gcc/tests` folder.

Generating the tests results for a specific version can be done with the
command:

```bash
bash ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-test-xpm.sh --package-version 12.4.0-1.1
```
...
- `npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@12.4.0-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/mingw-w64-gcc@12.4.0-1.1`
...
- paste the release name like **xPack MinGW-w64 GCC v12.4.0-1 released**
