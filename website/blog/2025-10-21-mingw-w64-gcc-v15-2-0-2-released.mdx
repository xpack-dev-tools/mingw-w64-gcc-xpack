...
title: xPack MinGW-w64 GCC v15.2.0-2 released
seo_title: Version 15.2.0-2 released
description: Version 15.2.0-2 is a maintenance release.
keywords:
  - xpack
  - mingw-w64-gcc
  - release

date: 2025-10-21 07:03:15 +0300
...
download_url: https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/releases/tag/v15.2.0-2/
...
Version **15.2.0-2.1** is a maintenance release; it updates to
the latest upstream master.

Version **15.2.0-2.1** is a new release; it reverts to using the POSIX thread model on Windows.
...
Compared to v15.2.0-1, this release reverts to using the POSIX thread model
on Windows, since some projects, like GDB 16.3, fail with the win32 threading
model.
...
[tests results page](/docs/tests/15.2.0-2/).
...
<CodeBlock language="console"> {
`C:\> tree /f %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\mingw-w64-gcc\\${frontMatter.version}.${frontMatter.npm_subversion}\\.content
Folder PATH listing
...
<CodeBlock language="console"> {
`$ tree -L 2 ~/Library/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
├── bin
...
<CodeBlock language="console"> {
`$ tree -L 2 ~/.local/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
/home/ilg/.local/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${frontMatter.version}.${frontMatter.npm_subversion}/.content/
├── README.md
├── bin
│   ├── i686-w64-mingw32-addr2line
│   ├── i686-w64-mingw32-ar
