...
`$ tree -L 2 ~/Library/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${ customField('releaseVersion') }.${ customField('npmSubversion') }/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/mingw-w64-gcc/${ customField('releaseVersion') }.${ customField('npmSubversion') }/.content/
├── bin
