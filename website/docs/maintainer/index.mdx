...
title: How to make new xPack MinGW-w64 GCC releases
...
```sh
xpm run clear-all-project-builds -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run generate-workflows -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
named like **xPack MinGW-w64 GCC v{customField('upstreamVersion')}-{customField('xpackSubversion')}** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/mingw-w64-gcc@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack MinGW-w64 GCC v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
