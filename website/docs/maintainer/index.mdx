...
npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@${customField('xpackVersion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/mingw-w64-gcc@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
