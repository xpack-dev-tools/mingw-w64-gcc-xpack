...
(such as **12.5.0-1.2**) with the following expression:
...
named such as **xPack MinGW-w64 GCC v12.5.0-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 12.5.0-1.2 release**_
