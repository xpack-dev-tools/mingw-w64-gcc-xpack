...
and fix them; assign them to a milestone (like <code>14.2.0-1</code>).
...
- add a new entry like _**\* v14.2.0-1 prepared**_
- commit with the message _**prepare v14.2.0-1**_
...
```sh
rm -f ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git pull
...
```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run clear-all-projects-builds -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-win32-x64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
git -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git pull
xpm run install -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
xpm run test-pre-release -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-publish-release -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
tagged like **v14.2.0-1** (mind the dash in the middle!) and
named like **xPack MinGW-w64 GCC v14.2.0-1** (mind the dash),
...
watching the mingw-w64-gcc-xpack project.
...
```sh
xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```

- edit the front matter properties
- select the correct summary
- commit with the message _**website: blog post release 14.2.0-1 published**_
...
```sh
xpm run update-package-binaries -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
- commit all changes with the message
  _**package.json: update urls for 14.2.0-1.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v14.2.0-1.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v14.2.0-1.1**_
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/mingw-w64-gcc?activeTab=versions">npmjs.com</a>.
...
```sh
xpm run trigger-workflow-test-xpm -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@14.2.0-1.1 latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/mingw-w64-gcc@14.2.0-1.1
`} </CodeBlock>
...
- switch to https://xpack-dev-tools.github.io/mingw-w64-gcc-xpack/docs/maintainer/#update-the-xpack-branch
...
```sh
xpm run trigger-workflow-deep-clean -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets
```
...
- paste the release name like _**xPack MinGW-w64 GCC v14.2.0-1 released**_
