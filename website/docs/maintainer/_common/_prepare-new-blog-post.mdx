...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/website run generate-website-blog-post
  ```
...
- **Commit** with the message _**website: blog post release 15.2.0-2.1 published**_
