...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm run generate-website-blog-post -C ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/website
  ```
...
- **Commit** with the message _**website: blog post release 12.5.0-1.2 published**_
