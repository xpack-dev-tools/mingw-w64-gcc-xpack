...
# How to obtain help for xPack MinGW-w64 GCC
...
- Review the [GitHub Discussions](https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/discussions) for
similar topics
- Examine the [GitHub Issues](https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/issues)
tracker and the
...
others, please 
utilise the [GitHub Discussions](https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/discussions)
pages.
