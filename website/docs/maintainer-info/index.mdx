...
title: Information for xPack MinGW-w64 GCC maintainers
...
```sh
bash ~/Work/xpack-dev-tools/mingw-w64-gcc-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
- <code>npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc</code>
- <code>npm dist-tag add @xpack-dev-tools/mingw-w64-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/mingw-w64-gcc</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/mingw-w64-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
