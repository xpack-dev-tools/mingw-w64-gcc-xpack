...
like <code>14.2.0-<b>1</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>14.2.0-1.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack MinGW-w64 GCC dependency via
a SemVer expressions
like <code>^14.2.0-1</code> or <code>~14.2.0-1</code>, and
