...
title: Getting Started with xPack MinGW-w64 GCC
...
**xPack MinGW-w64 GCC** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of MinGW-w64 GCC,
intended for reproducible builds.

<Overview/>

**xPack MinGW-w64 GCC** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/tree/xpack/scripts).
...
The details of installing the **xPack MinGW-w64 GCC** on various platforms are
presented in the
