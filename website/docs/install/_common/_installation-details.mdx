...
* identify the platform specific archive for the desired version
  of @xpack-dev-tools/mingw-w64-gcc, download it into a cache and unpack
...
* add <code>@xpack-dev-tools/mingw-w64-gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of the xPack MinGW-w64 GCC with
