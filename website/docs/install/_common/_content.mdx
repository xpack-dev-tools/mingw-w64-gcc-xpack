...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/mingw-w64-gcc@13.4.0-1.1 --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/mingw-w64-gcc/13.4.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/mingw-w64-gcc/13.4.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/mingw-w64-gcc/13.4.0-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-mingw-w64-gcc-13.4.0-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\mingw-w64-gcc\\xpack-mingw-w64-gcc-13.4.0-1</code>.
...
<ul>
<li><code>xpack-mingw-w64-gcc-13.4.0-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-mingw-w64-gcc-13.4.0-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-13.4.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/mingw-w64-gcc
cd ~/Library/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-13.4.0-1-darwin-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-13.4.0-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-mingw-w64-gcc-13.4.0-1-linux-x64.tar.gz</code></li>
<li><code>xpack-mingw-w64-gcc-13.4.0-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-13.4.0-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/mingw-w64-gcc
cd ~/.local/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-13.4.0-1-linux-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-13.4.0-1
`} </CodeBlock>
