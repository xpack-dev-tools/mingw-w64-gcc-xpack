...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/mingw-w64-gcc@12.5.0-1.2 --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/mingw-w64-gcc/12.5.0-1.2/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/mingw-w64-gcc/12.5.0-1.2/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/mingw-w64-gcc/12.5.0-1.2/.content/bin:$PATH
`} </CodeBlock>
