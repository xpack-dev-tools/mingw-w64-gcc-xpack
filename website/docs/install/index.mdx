...
The **xPack MinGW-w64 GCC** can be installed automatically, using the `xpm` command
...
<code>xpacks/@xpack-dev-tools/mingw-w64-gcc</code>.
...
**mingw-w64-gcc** package into the project:
...
* identify the platform specific archive for the latest available version
  of MinGW-w64 GCC, download it into a cache and unpack
...
* create a local symbolic link
  like <code>xpacks/@xpack-dev-tools/mingw-w64-gcc</code> pointing to the
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/mingw-w64-gcc@latest --global --verbose`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/mingw-w64-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/mingw-w64-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/mingw-w64-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`xpm uninstall @xpack-dev-tools/mingw-w64-gcc --verbose`
} </CodeBlock>
...
For all platforms, the **xPack MinGW-w64 GCC** binaries are released as portable
...
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
To manually install the <b>xPack MinGW-w64 GCC</b>,
unpack the archive and move it to a location of your choice.

The recommended location is
the <code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\mingw-w64-gcc</code> folder, for
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\mingw-w64-gcc\\xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
The recommended location is
the <code>~/Library/xPacks/mingw-w64-gcc</code> folder, for
example <code>/Users/ilg/Library/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/mingw-w64-gcc
cd ~/Library/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
...
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
* <code>xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm.tar.gz</code>
...
The recommended location is
the <code>~/.local/xPacks/mingw-w64-gcc</code> folder, for
example <code>/home/ilg/.local/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/mingw-w64-gcc
cd ~/.local/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
