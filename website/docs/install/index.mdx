...
title: How to install mingw-w64-gcc
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/mingw-w64-gcc@${customField('version')} --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/mingw-w64-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/mingw-w64-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/mingw-w64-gcc/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\mingw-w64-gcc\\xpack-mingw-w64-gcc-{customField('xpackVersion')}</code>.
...
example <code>/Users/ilg/Library/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/mingw-w64-gcc
cd ~/Library/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-${customField('xpackVersion')}
`} </CodeBlock>
...
example <code>/home/ilg/.local/xPacks/mingw-w64-gcc/xpack-mingw-w64-gcc-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/mingw-w64-gcc
cd ~/.local/xPacks/mingw-w64-gcc

tar xvf ~/Downloads/xpack-mingw-w64-gcc-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-mingw-w64-gcc-${customField('xpackVersion')}
`} </CodeBlock>
