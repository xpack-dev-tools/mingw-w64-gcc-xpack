...
const config: Config = {
  title: 'xPack MinGW-w64 GCC',
  tagline: 'A binary distribution of MinGW-w64 GCC',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/mingw-w64-gcc-xpack/blog/archive/**',
            '/mingw-w64-gcc-xpack/blog/authors/**',
            '/mingw-w64-gcc-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/mingw-w64-gcc/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/mingw-w64-gcc/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/mingw-w64-gcc/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/mingw-w64-gcc/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, mingw-w64-gcc'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
        {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/mingw-w64-gcc-xpack/discussions',
            },
            {
