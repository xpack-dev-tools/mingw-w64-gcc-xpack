...
declare -a XBB_APPLICATION_DEPENDENCIES=( binutils-mingw mingw gcc-mingw )
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( libiconv zlib gmp mpfr mpc isl xz zstd )
